...
int main(){
    ...
    // Aim is to access all the nodes just using Node a

    Node temp = a; // Temp is also a temporary node like we make temporary variable
    ...
    while(true){
        ...
        temp = (*(temp.next));  // Code to move to next Node
